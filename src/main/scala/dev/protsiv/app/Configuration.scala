...
object Configuration {
  ...
  val path:String = "https://api.ipify.org/?format=json" //for simplicity
    ...
    val liveEnv: Environment = Environment(new LiveConsole {}, LiveController(List(GetIp,ExitCommand)), new LiveClient {})
